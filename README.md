...
This repo contains the quickstarts demonstrating the reference implementations of [Power BI](https://powerbi.microsoft.com/) on [Databricks SQL](https://www.databricks.com/product/databricks-sql) and some of the best practices using Power BI on Databricks SQL.
